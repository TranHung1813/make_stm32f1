...
static int32_t cli_set_debug_level(p_shell_context_t context, int32_t argc, char **argv);
...
static int32_t cli_fake_power_event(p_shell_context_t context, int32_t argc, char **argv)
{
    ...
    {
        fake_power_event = 0;
        DEBUG_INFO("Power event OK\r\n");
    }
    else if (strstr(argv[1], "off"))
    {
        fake_power_event = 1;
        DEBUG_INFO("Power event ERR\r\n");
    }
    return 0;
}
