...
#define DEBUG_ISR_ENABLE                1       // allow debug inside interrupt service
...
#define DEBUG_INFO(s, args...)                  app_debug_print_raw(DEBUG_LEVEL_INFO, KGRN "<%u> %s : " s KNRM,  app_debug_get_ms(), "", ##args)
#else
