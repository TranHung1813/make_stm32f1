...
#define BOARD_HW_SMART_MODULE_PWR_CONTROL_PIN                           GPIO_PIN_4
#define BOARD_HW_SMART_MODULE_PWR_CONTROL_PORT                          GPIOB
...
#define BOARD_HW_ADC_5V_PIN                                             0
#define BOARD_HW_ADC_5V_PORT                                            0
#define BOARD_HW_EXT_WDT_PIN                                            0
#define BOARD_HW_EXT_WDT_PORT                                           0
#define BOARD_HW_SMART_MODULE_RST_PIN                                   0
#define BOARD_HW_SMART_MODULE_RST_PORT                                  0
#define BOARD_HW_TO_SM_POWER_STATE_PIN                                  0
#define BOARD_HW_TO_SM_POWER_STATE_PORT                                 0
#define BOARD_HW_HEARTBEAT_PIN                                          0
#define BOARD_HW_HEARTBEAT_PORT                                         0
//#define BOARD_HW_HEARTBEAT_EXTI_IRQn                                    EXTI2_3_IRQn
#define BOARD_HW_SW_OUT_PIN                                             0
#define BOARD_HW_SW_OUT_PORT                                            0
#define BOARD_HW_SW_IN_PIN                                              0
#define BOARD_HW_SW_IN_PORT                                             0
#define BOARD_HW_SMART_MODULE_PWR_KEY_PIN                               0
#define BOARD_HW_SMART_MODULE_PWR_KEY_PORT                              0
#define BOARD_HW_MIN_USART_TX_PIN                                       0
#define BOARD_HW_MIN_USART_TX_PORT                                      0
#define BOARD_HW_MIN_USART_RX_PIN                                       0
#define BOARD_HW_MIN_USART_RX_PORT                                      0
#define BOARD_HW_DISABLE_HOST_UART_PIN                                  0
#define BOARD_HW_DISABLE_HOST_UART_PORT                                 0
#define BOARD_HW_PA_CONTROL_PIN                                         GPIO_PIN_9
#define BOARD_HW_PA_CONTROL_PORT                                        GPIOA
#define BOARD_HW_INPUT1_PIN                                             0
#define BOARD_HW_INPUT1_PORT                                            0
#define BOARD_HW_INPUT2_PIN                                             0
#define BOARD_HW_INPUT2_PORT                                            0
#define BOARD_HW_INPUT3_PIN                                             0
#define BOARD_HW_INPUT3_PORT                                            0
#define BOARD_HW_INPUT4_PIN                                             0
#define BOARD_HW_INPUT4_PORT                                            0
#define BOARD_HW_OUTPUT1_PIN                                            0
#define BOARD_HW_OUTPUT1_PORT                                           0
#define BOARD_HW_OUTPUT2_PIN                                            0
#define BOARD_HW_OUTPUT2_PORT                                           0

#define EXT_OP_PB12_PORT                                                0
#define EXT_OP_PB12_PIN                                                 0

#define EXT_OP_PB13_PORT                                                0
#define EXT_OP_PB13_PIN                                                 0

#define EXT_OP_PB14_PORT                                                0
#define EXT_OP_PB14_PIN                                                 0

#define EXT_OP_PB15_PORT                                                0
#define EXT_OP_PB15_PIN                                                 0

#define BOARD_HW_BYPASS_DIDITAL_VOL_GPIO_PORT                           0
#define BOARD_HW_BYPASS_DIDITAL_VOL_GPIO_PIN                            0

#define BOARD_HW_SW_MIC_PORT                                            0
#define BOARD_HW_SW_MIC_PIN                                             0

#define FM_USARTPeripheral                                              USART2
#define FM_IRQHandler                                                   USART2_IRQHandler
#define HOST_USARTPeripheral                                            USART3
#define HOST_IRQHandler                                                 USART3_IRQHandler
